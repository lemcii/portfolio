<template>
    <div class="relative">
        <!-- todo: embed instead :S -->
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1144 128" fill="none">
            <path
                fill="currentColor"
        ...
        <div class="absolute text-black w-4/12 md:w-3/12 bottom-3/4 right-0">
            <!-- todo: embed instead :S -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 217 85" fill="none">
                <path
                    fill="currentColor"
